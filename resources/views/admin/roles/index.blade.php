	  ...
	  <div class="box">
		...
		<div class="box-body table-responsive no-padding">
		  <table class="table table-hover">
			...
			<tr>
			  <td><a href="{{route('admin.roles.edit', ['id'=>$role->id]) }}" >{{ $role->display_name }}</a></td>
			  ...
			  <td>
				<div class="btn-group">
				  ...
				  <ul class="dropdown-menu" role="menu">
					<li><a href="{{route('admin.roles.edit', ['id'=>$role->id]) }}">Editar</a></li>
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		...
		<a href="roles/delete/" id="act-link-delete"><button type="button" class="btn btn-outline">Sim</button></a>
	  </div>
	</div>
	<!-- /.modal-content -->
  </div>
